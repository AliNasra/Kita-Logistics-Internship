...
const TextTheme textThemeDefault = TextTheme(
    displaySmall:
        TextStyle(color: colorWhite, fontWeight: FontWeight.bold, fontSize: 48),
    headlineMedium:
        TextStyle(color: colorGrey, fontWeight: FontWeight.bold, fontSize: 32),
    titleMedium:
        TextStyle(color: colorGrey, fontWeight: FontWeight.bold, fontSize: 48));
